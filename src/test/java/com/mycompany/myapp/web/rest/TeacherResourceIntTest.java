...
public class TeacherResourceIntTest {
    ...
    private static final String DEFAULT_TEACHER_NO = "AAAAAAAAAA";
    private static final String UPDATED_TEACHER_NO = "BBBBBBBBBB";
    ...
    @Test
    @Transactional
    public void checkTeacherNoIsRequired() throws Exception {
