...
import { LabComponent } from 'app/entities/lab/lab.component';
import { LabService } from 'app/entities/lab/lab.service';
import { Lab } from 'app/shared/model/lab.model';

describe('Component Tests', () => {
    describe('Lab Management Component', () => {
        let comp: LabComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.labs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
